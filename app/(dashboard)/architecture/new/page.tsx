...
/**
 * New architecture request form. Board members upload the homeowner's request
 * along with supporting documents (scans, plans, material samples).
 * Files are uploaded to Supabase Storage client-side; the server action then
 * creates the DB rows and redirects to the new request's detail page.
 */
